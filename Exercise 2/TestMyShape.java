...
public class TestMyShape extends Application {  
  ...
  public void start(Stage ps) {
	  ...
	  /*
	  MyShape c = new MyOval(centerX,centerY,100,20,MyColor.BLACK);
	  c.draw(gc);
	  MyShape q = new MyRectangle(100,300,100,20,MyColor.BLACK);
	  q.draw(gc);
	  MyPolygon d = new MyPolygon(500,200,5,100,MyColor.BLACK);
	  d.draw(gc);
	  System.out.println(d.doOverlap(diagonal));
	  */
	  
	  MyLine a = new MyLine(400,400,500,600, MyColor.RED);
	  MyLine b = new MyLine(400,200,100,300, MyColor.BLACK);
	  MyLine c = new MyLine(100,100,400,400, MyColor.BLUE);
	  c.draw(gc);
	  a.draw(gc);
	  b.draw(gc);
	  MyShape box = new MyRectangle(600,200,200,200,MyColor.TRANSPARENT);
	  MyLine l = new MyLine(500,100,700,100,MyColor.BLACK);
	  l.draw(gc);
	  box.draw(gc);
	  //box.draw(gc);
	  //MyShape q = a.getMyBoundingBox();
	  //MyShape p = b.getMyBoundingBox();
	  //q.draw(gc);
	  //p.draw(gc);
	  //System.out.println(diagonal.doOverlap(box));
	  System.out.println(a.doOverlap(box));
